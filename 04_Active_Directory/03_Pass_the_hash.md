...
### Consideraciones de UAC (Cuentas Locales vs Dominio)
...
> Además hay que tener en cuenta. Por defecto la clave de registro: `FilterAdministratorToken` viene a 0. Pero si alguien la habilita, esto imposibilitará el Pass The Hash
...
## 🌐 1. Ataque PtH remoto
Los ataques se realizan de forma remota desde nuestra máquina atacante Linux hacia el objetivo.
...
## 💻 2. Ataques PtH en local
Es decir, los ataques se realizan directamente desde la propia máquina comprometida (Windows).
