...
## 💥 Ataques de Diccionario y Fuerza Bruta en AD
...
> Ojo si hay alguna política de bloqueo de intentos de login ya que puede fastidiarnos el ataque (verificar previamente con `--pass-pol`).
