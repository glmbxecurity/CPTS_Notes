...
## ⚡ 1. NetExec (nxc) - Preferencia para Microsoft Windows
...
## 🗡️ 2. Hydra - Preferencia para Linux
...
## 🛡️ 4. Metodologías ataques de credenciales

* Se pueden probar ataques de :
	* Diccionario: probando una lista de usuarios y de credenciales
	* Password Spraying: una lista de usuarios con la misma contraseña (util cuando se establece a todos los usuarios una clave por defecto tipo "Changem3")
	* Credenciales por defecto con defaultcreds-cheat-sheet
	* Reutilizacion de credenciales: cuando encontramos una pareja user:pass quizás se está utilizando para otro servicio
